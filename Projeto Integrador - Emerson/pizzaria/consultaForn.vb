    ...
    Private Sub btnOk_Click(sender As Object, e As EventArgs) Handles btnOk.Click
        ...
        If tipo = "System.String" Then
            ...
            If parametro = "Tem a palavra" Then
                cSql.CommandText = "SELECT * FROM Fornecedores WHERE CHARINDEX(" & valor & ", " & campo & ") > 0 "
            End If
            '------------------------------------------
            If parametro = "=" Then
                parametro = "="
                'Seleciona * onde o valor do campo for igual ao valor passado pelo usuario
                cSql.CommandText = "SELECT * FROM Fornecedores WHERE " & campo & " " & "= " & valor
            End If
            '----------------------------------------
            If parametro = "Começa com" Then
                ...
                cSql.CommandText = "SELECT * FROM Fornecedores WHERE LEFT(" & campo & ", " & range & ") = " & valor

            End If
            '------------------------------------------
            If parametro = "Termina em" Then
                'Retorna todos os valores dos campos em que o ultimo caracter é igual ao campo valor
                cSql.CommandText = "SELECT * FROM Fornecedores WHERE RIGHT(" & campo & ", " & range & ") = " & valor
            End If
